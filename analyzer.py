class MlAnalyzer:
    ...
    def calculate_similar_submitters(self, round_number, submitter_name):
        ...
        for pair in sorted_list:
            adjusted_list.append((pair[0], 1 - (pair[1] / (2 * self.parser.get_absolute_total_points_for_submitter(round_number, submitter_name)))))
